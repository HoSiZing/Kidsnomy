...
import styles from './SavingContractModal.module.css';

interface SavingContractModalProps {
  isOpen: boolean;
  onClose: () => void;
  productId: number;
  productName: string;
...
const SavingContractModal: React.FC<SavingContractModalProps> = ({
  isOpen,
  onClose,
  productId,
  productName,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: API 연동
      console.log('적금 상품 계약 요청:', { productId, productName, amount });
...
export default SavingContractModal; 