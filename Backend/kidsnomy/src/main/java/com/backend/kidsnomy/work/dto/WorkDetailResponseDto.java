...
public class WorkDetailResponseDto {
    ...
    public static WorkDetailResponseDto fromEntity(Work work, String groupCode, User employer, User employee) {
        WorkDetailResponseDto dto = new WorkDetailResponseDto();
